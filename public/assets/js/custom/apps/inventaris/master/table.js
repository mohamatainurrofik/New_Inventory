...
const productList = function () {
    ...
    const initUnitkerjaTable = () => {
        datatable = $(table).DataTable({
            "ajax": {
                "url" :`${document.location.origin}/InventarisController/productList` ,
                "dataSrc" : "",
            },
            'order': [],
            "pageLength": 10,
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return `
                                    <a href="/Inventaris/product/${row['id']}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
    ...
    const initToggleToolbar = () => {
        ...
        // Select elements
        toolbarBase = document.querySelector('[data-kt-product-table-toolbar="base"]');
        toolbarSelected = document.querySelector('[data-kt-product-table-toolbar="selected"]');
        ...
        deleteSelected.addEventListener('click', function () {
            // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
            Swal.fire({
                text: "Yakin ingin menghapus seluruh product yang dipilih ?",
                icon: "warning",
                showCancelButton: true,
                buttonsStyling: false,
                confirmButtonText: "Ya, Hapus!",
                ...
                if (result.value) {
                    ...
                    try {
                        fetch('/InventarisController/productDelete',{
                            method : "POST",
                        ...
                        setTimeout(function () {
                            Swal.fire({
                                text: "Berhasil menghapus seluruh product yang dipilih!.",
                                icon: "success",
                                buttonsStyling: false,
                                confirmButtonText: "Ok, Mengerti!",
                                customClass: {
